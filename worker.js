...
const BOT_TOKEN = "8322232113:AAFC_dl_grllwLGHUxJfYB0XNGUHovhCBmE";
const BOT_WEBHOOK = "/endpoint";
const BOT_SECRET = "Error99oP";
const BOT_OWNER = 6181269269;
const BOT_CHANNEL = -1001664331463;
const SIA_SECRET = "Error999oP";
